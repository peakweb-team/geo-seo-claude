...
ACTION_CATALOG = {
    ...
    "publish_llms_txt": {
        ...
        "whyItMatters": "Several AI tools (Claude, some Perplexity configurations, and LLM-powered agents) read llms.txt as a structured site index. It gives AI systems an authoritative, compact overview of who you are and what you offer.",
        "controlLevel": "direct",
        "difficultyLevel": "low",
